...
NomServoList = ["FB_ServoBas", "FB_ServoHaut"]
ListValeurNom = plc.CreationVariableList("Servo", NomServoList)
        ...
        if Val_ModeRun[0] == 3:
            ...
            for i in range(len(Val_ID)):
                ...
                if Val_Prioritaire[i] == True:
                    print("...................en 2 pas normal..............................................")
                    print(Val_Prioritaire[i])
                    Val_PositionOrdre[i] = plc.Lit_Variable(Nom_PositionOrdre[i])
                    Val_Vitesse[i] = plc.Lit_Variable(Nom_Vitesse[i])
